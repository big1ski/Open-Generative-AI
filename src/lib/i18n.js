...
const translations = {
    en: {
        ...
        'settings.keyNote': 'Your API key is stored locally and sent only to queue.fal.run via the /api/fal proxy.',
        'settings.invalidKey': 'Please enter a valid API key.',

        // Auth Modal
        'auth.title': 'fal.ai API Key Required',
        'auth.subtitle': 'Create a fal.ai key at fal.ai/dashboard/keys, then paste the key value here to start generating.',
        'auth.keyLabel': 'fal.ai API Key',
        'auth.keyPlaceholder': 'Paste your fal.ai key value...',
        'auth.keyNote': 'Paste the key value directly — do not include the "Key " prefix.',
    ...
    zh: {
        ...
        'settings.keyNote': '您的 API 密钥仅存储在本地，通过 /api/fal 代理发送到 queue.fal.run。',
        'settings.invalidKey': '请输入有效的 API 密钥。',

        // Auth Modal
        'auth.title': '需要 fal.ai API 密钥',
        'auth.subtitle': '在 fal.ai/dashboard/keys 创建密钥，然后将密钥值粘贴到这里开始生成。',
        'auth.keyLabel': 'fal.ai API 密钥',
        'auth.keyPlaceholder': '粘贴您的 fal.ai 密钥值...',
        'auth.keyNote': '直接粘贴密钥值，不需要包含 "Key " 前缀。',
        'auth.initBtn': '初始化工作室',
